...
import DiscordCAMRU from "./Discord_CAMRU.jsx";
import DiscordMRU from "./Discord_MRU.jsx";
import Events from "./Events.jsx";
import VantaCells from '../VantaJS-animated/VantaCells.jsx';
import GeometricGradient from "../animated-components/GeometricGradient";
import WorkInProgress from "./WorkInProgress";
import InvolvedSocials from "./InvolvedSocials";
  ...
  const getName = (e) => {
    ...
    if (localStorage.getItem("name")) {
      ...
      if (serachParam !== undefined) {
        fetch(`${import.meta.env.VITE_SSL}://${import.meta.env.VITE_SERVER_HOST}/name?id=${serachParam}`)
