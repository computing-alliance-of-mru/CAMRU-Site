  ...
  return (
    ...
    <div className="w-[300px] rounded">
      <div className="w-full bg-[#5865f2] h-[50px] rounded-t flex justify-center items-center shadow-lg">
        <svg 
          className="w-6 h-6 pr-1 fill-white"
      ...
      <div className="bg-[#f0f0f0] w-full p-4 rounded-b shadow-lg h-[250px]">
      ...
      <div className="w-full h-[50px] flex justify-center items-center text-center my-2">
      ...
      <div className="flex">
        ...
        <div className="w-full h-[50px] flex justify-center items-center">
          ...
          <span className="px-1 text-gray-600" >{members}</span><p className="text-gray-600">Members</p>
        </div>
      </div>
