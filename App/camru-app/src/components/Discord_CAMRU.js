...
const Discord = (prop) => {
	const [discordData, setDiscordData] = useState(
		JSON.parse(localStorage.getItem("discord-data"))
	);

	useEffect(() => {
		fetch(
			`${process.env.REACT_APP_SSL}://${process.env.REACT_APP_SERVER_HOST}/api/discord/count`
		)
	...
	return (
		<div className="w-[100%] rounded">
			<div className="bg-[#f0f0f0] w-full p-4 rounded shadow-lg h-[250px]">
				<p className="text-center text-md font-semibold text-black mb-3">
					Join Our Discord
				</p>
				<div className="w-full h-[50px] flex justify-center items-center my-1">
					<img
						src="https://cdn.discordapp.com/icons/492045394327371776/97362c76447afec4760968721a3856c0.webp"
						alt="discord"
				...
				<div className="w-full h-[50px] flex justify-center items-center pt-2 max-w-[250px] mx-auto">
					<a
						className="hover:bg-[#7289DA] bg-[#5865f2] w-full h-[30px] rounded-full text-white font-bold flex items-center justify-center shadow-md"
						href="https://discord.gg/SDdB7DwZYz"
						target="_blank"
					>
						<svg
						...
						<span className="pl-1">Join Now</span>
					</a>
				</div>
			</div>
		</div>
